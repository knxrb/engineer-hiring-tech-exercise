...
bandit -r -q . -x ./.venv --format screen && echo

purple echo 'Checking for errors, potential problems, convention violations and complexity (Ruff).' && \
uvx ruff check . && echo

# Tests, Coverage, and Formatting Checks
purple echo 'Running unit tests and checking coverage:' && \
